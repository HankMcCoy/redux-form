...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_38__) {
...
var _splice = __webpack_require__(60);

var _splice2 = _interopRequireDefault(_splice);

var _getIn = __webpack_require__(61);
...
var REGISTER_FIELDS = exports.REGISTER_FIELDS = prefix + 'REGISTER_FIELDS';
...
var UNREGISTER_FIELDS = exports.UNREGISTER_FIELDS = prefix + 'UNREGISTER_FIELDS';
...
var _isReactNative = __webpack_require__(58);
...
var _isEqualWith2 = __webpack_require__(30);
...
var registerFields = function registerFields(form, registrations) {
  return {
    type: _actionTypes.REGISTER_FIELDS,
    meta: { form: form },
...
var unregisterFields = function unregisterFields(form, unregistrations) {
  return {
    type: _actionTypes.UNREGISTER_FIELDS,
    meta: { form: form },
    payload: {
      // Default destroyOnUnmount to true
      unregistrations: unregistrations.map(function (ur) {
        return ur.destroyOnUnmount === undefined ? _extends({}, ur, { destroyOnUnmount: true }) : ur;
      })
    }
  };
};
...
var _isEvent = __webpack_require__(27);
...
var _SubmissionError = __webpack_require__(24);
...
var _Field = __webpack_require__(54);
...
var registerFields = exports.registerFields = _actions2.default.registerFields;
...
var unregisterFields = exports.unregisterFields = _actions2.default.unregisterFields;
...
var _createField = __webpack_require__(55);
...
var _ConnectedField = __webpack_require__(56);

var _ConnectedField2 = _interopRequireDefault(_ConnectedField);

var _shallowCompare = __webpack_require__(34);
...
var _createFieldProps2 = __webpack_require__(25);

var _createFieldProps3 = _interopRequireDefault(_createFieldProps2);

var _onChangeValue = __webpack_require__(26);

var _onChangeValue2 = _interopRequireDefault(_onChangeValue);

var _eventConsts = __webpack_require__(59);
...
var _mapValues2 = __webpack_require__(35);
...
var _merge4 = __webpack_require__(141);
...
var _debounce2 = __webpack_require__(169);
...
var _asyncValidation = __webpack_require__(173);
...
var _silenceEvent = __webpack_require__(46);

var _silenceEvent2 = _interopRequireDefault(_silenceEvent);

var _silenceEvents = __webpack_require__(174);

var _silenceEvents2 = _interopRequireDefault(_silenceEvents);

var _generateValidator = __webpack_require__(175);

var _generateValidator2 = _interopRequireDefault(_generateValidator);

var _handleSubmit = __webpack_require__(176);
    ...
    return function (WrappedComponent) {
      var Form = function (_Component) {
        ...
        function Form() {
          ...
          return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.destroyed = false, _this.fieldValidators = {}, _this.lastFieldValidatorKeys = [], _this.fieldWarners = {}, _this.lastFieldWarnerKeys = [], _this.innerOnSubmit = undefined, _this.submitPromise = undefined, _this.queuedRegistrations = [], _this.queuedUnregistrations = [], _this.getValues = function () {
            ...
            _this.registerFieldMethods(name, getValidator, getWarner);
          }, _this.asyncRegister = function (name, type, getValidator, getWarner) {
            _this.queueRegister(name, type);
            _this.registerFieldMethods(name, getValidator, getWarner);
          }, _this.registerFieldMethods = function (name, getValidator, getWarner) {
            if (getValidator) {
          ...
          }, _this.queueRegister = function (name, type) {
            // If there are any queued unregisters for this field, just remove
            // those instead.
            if ((0, _remove3.default)(_this.queuedUnregistrations, function (r) {
              return r.name !== name;
            }).length) {
              // Otherwise, add it to the queue, and schedule a flush
              _this.queuedRegistrations.push({
                name: name,
                type: type
              });
              _this.flushRegistrationsSoon();
            }
          }, _this.queueUnregister = function (name) {
            var destroyOnUnmount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

            // If there are any queued registers for this field, just remove
            // those instead.
            if ((0, _remove3.default)(_this.queuedRegistrations, function (r) {
              return r.name !== name;
            }).length) {
              // Otherwise, add it to the queue, and schedule a flush
              _this.queuedUnregistrations.push({
                name: name,
            ...
            if (!_this.destroyed) {
              if (_this.props.destroyOnUnmount || _this.props.forceUnregisterOnUnmount) {
                ...
                _this.unregisterFieldMethods(name);
              } else {
                _this.props.unregisterField(name, false);
              }
            }
          }, _this.asyncUnregister = function (name) {
            if (!_this.destroyed) {
              if (_this.props.destroyOnUnmount || _this.props.forceUnregisterOnUnmount) {
                _this.queueUnregister(name);
                _this.unregisterFieldMethods(name);
              } else {
                _this.queueUnregister(name, false);
              }
            }
          }, _this.unregisterFieldMethods = function (name) {
            delete _this.fieldValidators[name];
            delete _this.fieldWarners[name];
          }, _this.flushRegistrationsSoon = (0, _debounce3.default)(function () {
            _this.queuedRegistrationGroups.forEach(function (group) {
              if (group.type === 'REGISTER') {
                _this.props.registerFields(_this.queuedRegistrations);
              } else {
                _this.props.unregisterFields(_this.queuedUnregistrations);
              }
            });
          }, 0), _this.getFieldList = function (options) {
        ...
        _createClass(Form, [{
          ...
          value: function getChildContext() {
            ...
            return {
              _reduxForm: _extends({}, this.props, {
                ...
                register: config.asyncRegister ? this.asyncRegister : this.register,
                unregister: config.asyncRegister ? this.asyncUnregister : this.unregister,
          ...
          value: function render() {
            ...
            var _props7 = this.props,
                ...
                registerFields = _props7.registerFields,
                reset = _props7.reset,
                ...
                unregisterFields = _props7.unregisterFields,
                ...
                rest = _objectWithoutProperties(_props7, ['anyTouched', 'arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncErrors', 'asyncValidate', 'asyncValidating', 'blur', 'change', 'clearSubmit', 'destroy', 'destroyOnUnmount', 'forceUnregisterOnUnmount', 'dirty', 'dispatch', 'enableReinitialize', 'error', 'focus', 'form', 'getFormState', 'initialize', 'initialized', 'initialValues', 'invalid', 'keepDirtyOnReinitialize', 'pristine', 'propNamespace', 'registeredFields', 'registerField', 'registerFields', 'reset', 'setSubmitFailed', 'setSubmitSucceeded', 'shouldAsyncValidate', 'shouldValidate', 'startAsyncValidation', 'startSubmit', 'stopAsyncValidation', 'stopSubmit', 'submitting', 'submitFailed', 'submitSucceeded', 'touch', 'touchOnBlur', 'touchOnChange', 'persistentSubmitErrors', 'syncErrors', 'syncWarnings', 'unregisterField', 'unregisterFields', 'untouch', 'updateSyncErrors', 'updateSyncWarnings', 'valid', 'validExceptSubmit', 'values', 'warning']);
...
var baseUnset = __webpack_require__(136),
...
var assignMergeValue = __webpack_require__(40),
    ...
    isTypedArray = __webpack_require__(33),
    toPlainObject = __webpack_require__(159);
...
function createReducer(structure) {
  ...
  var registerField = function registerField(state, name, type) {
  ...
  var unregisterField = function unregisterField(state, name, destroyOnUnmount) {
    var result = state;
    var key = 'registeredFields[\'' + name + '\']';
  ...
  var behaviors = (_behaviors = {}, _defineProperty(_behaviors, _actionTypes.ARRAY_INSERT, function (state, _ref) {
  ...
  }), _defineProperty(_behaviors, _actionTypes.REGISTER_FIELDS, function (state, _ref18) {
    var registrations = _ref18.payload.registrations;

    return registrations.reduce(function (curState, _ref19) {
  ...
  }), _defineProperty(_behaviors, _actionTypes.UNREGISTER_FIELDS, function (state, _ref26) {
    var unregistrations = _ref26.payload.unregistrations;

    return unregistrations.reduce(function (curState, _ref27) {
      var name = _ref27.name,
          destroyOnUnmount = _ref27.destroyOnUnmount;

      return unregisterField(curState, name, destroyOnUnmount);
    }, state);
  }), _defineProperty(_behaviors, _actionTypes.UNTOUCH, function (state, _ref28) {
    var fields = _ref28.meta.fields;
    ...
    return result;
  }), _defineProperty(_behaviors, _actionTypes.UPDATE_SYNC_ERRORS, function (state, _ref29) {
    var _ref29$payload = _ref29.payload,
        syncErrors = _ref29$payload.syncErrors,
        error = _ref29$payload.error;
    ...
    return result;
  }), _defineProperty(_behaviors, _actionTypes.UPDATE_SYNC_WARNINGS, function (state, _ref30) {
    var _ref30$payload = _ref30.payload,
        syncWarnings = _ref30$payload.syncWarnings,
        warning = _ref30$payload.warning;
